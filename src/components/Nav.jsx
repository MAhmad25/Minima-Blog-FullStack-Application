...
const Nav = () => {
      return (
            <nav className="max-w-full sticky top-0 left-0 flex  justify-between md:items-center text-[var(--color-bl)]  font-primary-text md:h-20">
                  {/* Logo Section */}
                  ...
                  <section className="md:flex  flex-3/6 md:pl-10 lg:pl-50 bg-[var(--color-wht)] top-20 left-0 hidden  absolute md:static md:top-0 md:left-0  md:h-fit  w-full h-screen md:justify-between  md:gap-10 md:items-center ">
                        ...
                        <section className="flex flex-col md:flex-row mt-10 md:mt-0 md:items-center  px-10  gap-5">
                              <Link to="/write-post" className="flex w-fit gap-1 text-xl md:text-sm border-[0.3px] px-2 py-2 md:px-3  md:py-2 rounded-xl">
                                    <LuSquarePen />
                                    <p className="leading-none tracking-tight">Write Post</p>
                              </Link>
